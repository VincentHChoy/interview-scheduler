...
describe("Form", () => {
  ...
  it("can successfully display error message after submitting empty student name", () => {
    const onSave = jest.fn();
  ...
  it("can successfully save after trying to submit an empty student name with given interviewer", () => {
    const onSave = jest.fn();
    const { getByText, getByPlaceholderText, queryByText } = render(
